...
@section('content')
    ...
    @endif
    @if(!is_null($groups))
        @include('blade-frontend.partials.pagination', [ 'paginator' => $groups])
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-secondary"
                               href="{{ route('admin.groups.permalink', [ 'group' => $group->id]) }}">View</a>
                            @if(\App\Facades\AuthUserFacade::hasPermission('admin-groups-permissions-view'))
                                <a class="btn btn-outline-secondary"
                                   href="{{ route('admin.groups.permissions', [ 'group' => $group->id]) }}">Permissions</a>
                            @endif
                        </td>
                    </tr>
                @endforeach
