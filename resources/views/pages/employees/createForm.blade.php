    ...
    <div class="container-fluid">
        ...
        <form action="{{ route(name: 'employees.create') }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="firstNameInput" name="firstName" placeholder="Please enter first name..."
                       required/>
            </div>
            <div class="form-group mb-3">
                <label class="form-label" for="lastNameInput">Last name: </label>
                <input type="text" class="form-control" id="lastNameInput" name="lastName" placeholder="Please enter last name..."
                       required/>
            </div>
            <div class="form-group mb-3">
