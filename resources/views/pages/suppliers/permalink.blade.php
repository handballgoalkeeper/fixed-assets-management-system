...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route(name: 'suppliers.update', parameters: [ 'supplier' => $supplier->id ]) }}" method="POST">
            @csrf
            <div class="form-group mb-3">
                <label class="form-label" for="nameInput">Name</label>
                <input type="text" class="form-control" id="nameInput" name="name" value="{{ $supplier->name }}" required />
            </div>
            <div class="form-group mb-3">
                <label class="form-label" for="descriptionInput">Description</label>
                <input type="text" class="form-control" id="descriptionInput" name="description" value="{{ $supplier->description }}" />
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="contactPersonInput" name="contactPerson" value="{{ $supplier->contact_person }}" />
            </div>
            <div class="form-group mb-3">
