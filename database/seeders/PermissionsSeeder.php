...
class PermissionsSeeder extends Seeder
{
    const PERMISSIONS = [
        ...
        'assets-manage' => 'Allows authenticated user to manage assets.',
        'assets-assign-to-employee' => 'Allows authenticated user to assign assets to employees.',
        'assets-remove_from-employee' => 'Allows authenticated user to remove assets from employees.',
