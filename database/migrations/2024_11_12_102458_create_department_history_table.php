...
return new class extends Migration
{
    ...
    {
        Schema::create(table: DepartmentHistoryModel::TABLE, callback: function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger(column: 'department_id')->nullable();
            $table->string(column: 'action', length: 6);
            $table->string(column: 'name', length: 255)->nullable();
    ...
    {
        Schema::dropIfExists(table: DepartmentHistoryModel::TABLE);
    }
};
